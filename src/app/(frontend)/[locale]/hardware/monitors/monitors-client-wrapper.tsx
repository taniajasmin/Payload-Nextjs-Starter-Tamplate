...
const jsonLd = {
  ...
  "@type": "ItemList",
  name: "Monitors — Simal Technologies",
...
export function MonitorsPageClient({ initialData, products }: Props) {
  ...
  const heroHeadline = hero?.headline || "Monitors";
  const heroDescription = hero?.description || `Browse our complete range of <strong class="text-white">${products.length} authentic monitors</strong> from leading brands. Gaming, professional, and everyday productivity displays — sourced directly from authorized manufacturers with full warranty.`;
  const relatedLinks = (data.relatedLinks as string) || `Related Categories: <a href="/hardware/product-catalog" class="underline hover:text-neutral-900">Full Product Catalog</a> | <a href="/hardware/computer-components" class="underline hover:text-neutral-900">Computer Components</a> | <a href="/hardware/computer-accessories" class="underline hover:text-neutral-900">Computer Accessories</a> | <a href="/hardware/gaming" class="underline hover:text-neutral-900">Gaming</a> | <a href="/hardware/laptops" class="underline hover:text-neutral-900">Laptops</a>`;
